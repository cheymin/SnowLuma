...
ENV DEBIAN_FRONTEND=noninteractive \
    ...
    SNOWLUMA_WEBUI_BOOTSTRAP_PASSWORD=admin123 \
...
# Persistent storage volume — mount /data to survive container restarts.
# Layout: /data/config (webui.json, runtime.json, onebot_*.json),
#         /data/data   (SQLite: messages.db, media.db, reactions.db per UIN),
#         /data/logs   (rotating file logs).
VOLUME ["/data"]
